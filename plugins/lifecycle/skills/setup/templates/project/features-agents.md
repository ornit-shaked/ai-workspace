...
After creating a plan, recommend running `lifecycle:review` before user approval.
After writing a spec, recommend running `lifecycle:review` before user approval.
