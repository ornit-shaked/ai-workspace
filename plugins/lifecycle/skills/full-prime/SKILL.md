...
## Initialization check (first, before anything else)

If `.features/` does not exist at project root, report exactly: "Lifecycle plugin not initialized. Run /lifecycle:setup first." and stop — do not read any files or print a summary.
