...
- **Source:** [ADR-0001](./project/.claude/adr/ADR-0001-state-management-bloc.md)
...
- **Source:** [ADR-0002](./project/.claude/adr/ADR-0002-freezed-everywhere.md)

### 3. **very_good_analysis**
- **What:** Stricter linting baseline than default `flutter_lints`
- **Why:** Enforce higher code quality standards
- **Source:** [ADR-0003](./project/.claude/adr/ADR-0003-linting-very-good.md)
...
- **Source:** [ADR-0004](./project/.claude/adr/ADR-0004-flavors.md)
...
- **Source:** [ADR-0005](./project/.claude/adr/ADR-0005-folder-structure.md)
...
- **Source:** [ADR-0006](./project/.claude/adr/ADR-0006-adr-process.md)
