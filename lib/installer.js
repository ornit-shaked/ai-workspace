...
function install(pluginName, targetDir, agent) {
  ...
  _generatePluginFile(manifest, projectDir, pluginDir);
 ...
 */
function _generatePluginFile(manifest, projectDir, pluginDir) {
...
For full documentation, see: [${manifest.name} README](https://github.com/oshaked/ai-workspace/tree/main/plugins/${manifest.name})
`;
